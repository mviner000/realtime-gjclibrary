...
const ChangePassword2 = () => {
  ...
  const handleEncrypt = () => {
    if (
      !validateNoSpaces(oldPassword) ||
      !validateNoSpaces(newPassword) ||
      !validateNoSpaces(repeatPassword)
    ) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      setError(
        "Old password and new password must be at least 8 characters long"
      );
      setIsLoading(false);
      return;
    }
