        ...
        <div className="w-full align-middle relative">
          <div className="container pt-8 space-x-2 flex w-full justify-between">
            <div className="flex gap-2">
              <Link
                className="hover:bg-emerald-400/80 p-2 bg-gray-400 text-white dark:bg-transparent dark:text-gray-500 outline outline-1 outline-black dark:outline-white rounded-md"
                href="/students"
              >
                Back
              </Link>
